...
// var child = child_process.spawn('phantomjs');  //, ['C:/Users/kkhalsa/workspace/misc_scripts/phantomjs/suspendmonitors.js']

console.log('\n=============');
// console.log(child);
// console.log(typeof child);
// console.log(child.webpage);
console.log();

// var child2 = child_process.spawn("ls", {
//     stdio: [
...
console.log('------------');
// console.log(child2.stdio);
// console.log();
// // console.log(child2.stdio[0]);
// console.log(child2.stdin);
// console.log();
// console.log(child2.stdout);
console.log();

console.log('........');
// var ls = child_process.spawn('ls', ['-lh', '/home']);
...
var child3 = child_process.exec('./node_modules/phantomjs/bin/phantomjs pyramid_sacrud/static/js/tests/pjs.js',
