...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("function" == TYPE_FUNCTION && __webpack_require__(34)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DeleteButton = (function () {
	  ...
	  function DeleteButton(selector) {
	  ...
	  _createClass(DeleteButton, [{
	    key: "disable",
	    get: function get() {
	      if (this.obj.hasClass("disabled")) return true;else return false;
	    },
	    set: function set(value) {
	      if (value === true) this.obj.removeClass("red").addClass("disabled");else this.obj.removeClass("disabled").addClass("red");
	    }
	  }]);
