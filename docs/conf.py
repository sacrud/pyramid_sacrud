# -*- coding: utf-8 -*-
#
# sacrud documentation build configuration file, created by
...
latex_documents = [
  ('index', 'sacrud.tex', u'sacrud Documentation',
   u'Author', 'manual'),
]
...
man_pages = [
    ('index', 'sacrud', u'sacrud Documentation',
     [u'Author'], 1)
]
...
texinfo_documents = [
  ('index', 'sacrud', u'sacrud Documentation',
   u'Author', 'sacrud', 'One line description of project.',
   'Miscellaneous'),
]
